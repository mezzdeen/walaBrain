...
function Sidebar({
  ...
  // `side` is logical; the Sheet takes a physical side, so mirror it in RTL.
  const sheetSide =
    ...
    >
      ...
      <div
        className={cn(
          ...
          // `left`/`right` are read as inline-start/inline-end so the sidebar
          // follows the reading direction instead of the physical viewport.
          side === "left"
...
function SidebarMenuButton({
  ...
  return (
    <Tooltip>
      ...
      <TooltipContent
        // The collapsed rail sits at the inline start, so the tooltip has to
        // open away from it rather than always to the physical right.
