                    ...
                    <p className="text-sm text-muted-foreground">
                        ...
                        {passkey.last_used_at_diff && (
                            <>
                                ...
                                {t('core.settings.passkey_last_used', {
                ...
                <DialogTrigger asChild>
                    ...
                    >
                        ...
                        <span className="sr-only">
                            {t('core.settings.remove')}
                        </span>
                    </Button>
                </DialogTrigger>
                <DialogContent>
                    <DialogTitle>
                        {t('core.settings.remove_passkey')}
                    </DialogTitle>
                    <DialogDescription>
                        {t('core.settings.remove_passkey_confirm', {
                            name: passkey.name,
                        })}
                    </DialogDescription>
